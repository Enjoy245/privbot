...
.setThumbnail()
.addField(`<:xr_duyuru:804641161461497866> Kısa bir Teşekkür.`, `・xR Botu sunucunuza Eklediğniz için ve bize Destek olduğunuz için sizlere minnetarız.`)
.addField(`<:xr_tamir:804641155043295262> Prefix`, `・**xR Botun Sabit Prefix'i  = \`${fynx.prefix}\`\n\n Değiştirebilmek için \`${fynx.prefix}prefix\` Yazabilirsiniz.**`)
.addField(`<a:xr_url:804641119286591488> Linkler`, `・Botu farklı sunucunuza eklemek için **${fynx.prefix}davet**\n ・Bot hakkında detaylı yardım almak için **${fynx.prefix}destek-sunucum** yazabilirsiniz.`)
.addField(`x! Yardım Yazarak Bottaki Tüm Komutlara Erişebilirsiniz.`)
.setFooter(`xR BOT`)
.setTimestamp();
...
var oyun = [
`✨ Yardım almak için | x!yardım`,
`🚀 Yeni Özellikler İçin | x!yardım`,
`🔔 Yenilenen Tasarımı İle`,
`⚡️ Botu eklemek için | x!davet`,
`🌟 Prefix ayarlamak için | x!prefix`
]
...
client.on('message', async msg => {
  ...
  if(msg.content == `<@!803503686734315531>`) return msg.channel.send(`<a:xr_elsallama:801079094132342824>  Merhaba, Şu Anki Prefixim :\`${prefix}\` \n <a:xr_hype:798569692335177769> Prefiximi Değiştirmek İsterseniz **x!prefix ayarla <Prefix>** `);
});
...
client.on("guildMemberAdd", async member => {
  ...
  ///....
  if (!mesaj) {
    return client.channels.cache.get(kanal).send("<a:xr_katildi:804703968764100649> `"+ member.user.username + "`**Adlı Kullanıcı Aramıza Katıldı!** \n\n <:xr_yildiz:804641157300748320>  `" + sayaç + "` **Kişi Olmamıza** `" + sonuç + "` **Kişi Kaldı.** \n\n <:xr_liste:804641150005805068> `" + member.guild.memberCount + "` **Kişiyiz!**");
  }

  if (member.guild.memberCount == sayaç) {
    return client.channels.get(kanal).send(`<:xr_unlem:798805982633132042> **Sayaç Sıfırlandı!** \`${member.guild.memberCount}\` **Kişiyiz!**`)
...
client.on("guildMemberRemove", async member => {
  ...
  if (!mesaj) {
    return client.channels.cache.get(kanal).send("<a:xr_ayrildi:804703962892599346>  `" + member.user.username + "` **Adlı Kullanıcı Aramızdan Ayrıldı.** \n\n <:xr_yildiz:804641157300748320> `" + sayaç + "` **Kişi Olmamıza** `" + sonuç + "` **Kişi Kaldı.** \n\n <:xr_liste:804641150005805068> `" + member.guild.memberCount + "` **Kişiyiz!**");
      }
...
client.on("guildMemberAdd", async member => {
  ...
  if (!mesaj) {
    client.channels.cache.get(kanal).send("<a:xr_elsallama:801079094132342824> **Selam!** `" + member.user.username + "`**!kayıtol yazarak kayıt olabilirsin!**");
...
client.on("guildMemberAdd", async member => {
  ...
  if (!mesaj) {
    client.channels.cache.get(kanal).send("▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ <:xr_onay:798218982170820628> `" + member.user.username + "`**Hoş Geldin! Otomatik Rolün Verildi.** \n\n ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬");
