...
.addField(`**Genel Komutlar**`,`・ \`${prefix}genel\``,true)
.addField(`**Mod Komutları**`,`・\`${prefix}moderasyon\` `,true)
.addField(`**Guard Komutları**`,`・\`${prefix}guard\`  `,true)
.addField(`**Müzik Komutları**`,`・\`${prefix}müzik\` `,true)
.addField(`**Eklenti Komutları**`,`・ \`${prefix}sistemler\`  `,true)
.addField(`**Logo Komutları**`,`・ \`${prefix}logo\` `,true)
